    ...
    async function handleOnSubmit(values){
        ...
        Array.from(values.currentTarget.elements).forEach(field =>{
            ...
            if(((field.name=="name")&&(field.value==""))||((field.name=="mail")&&(field.value==""))||((field.name=="subject")&&(field.value==""))||((field.name=="message")&&(field.value==""))){
                ...
                nb+=1;
            }else if((field.name=="mail")&&((field.value<8)||(field.value>120)||(field.value==/^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i))){
                console.log("mail is too short or long or mail terms");
                nb+=1;
            }
        });
        if (nb==0){
                            ...
                            >
                                <div className="contact-form">
                                    ...
                                    <div className="submit-btn mt-20">
                                        <button className="ht-btn ht-btn-md" type="submit" onClick={notify}>{t("contact:Envoyer")} </button>
                                        <ToastContainer />
                                    </div>
                                </div>
                            </form>
