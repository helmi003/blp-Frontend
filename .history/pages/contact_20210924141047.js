...
export default function contact() {
    ...
    const { register, handleSubmit} = useForm<FormVakues>();
                                ...
                                <div className="contact-form">
                                    <div className="contact-input">
                                        <div className="contact-inner">
                                            <input name="name" type="text" ref={register()} placeholder="Nom"  />
                                        </div>
                                        <div className="contact-inner">
                                            <input name="mail" type="email"  ref={register()} placeholder="Email " />
                                        </div>
                                    </div>
                                    <div className="contact-inner">
                                        <input name="subject" type="text" ref={register()} placeholder="Objet "  />
                                    </div>
