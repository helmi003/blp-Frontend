...
export default function contact() {
    ...
    const {
        register, handleSubmit, formState: { errors }  } = useForm<FormValues>();
                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 col-lg-6">
                        <div className="contact-form-wrap">
                            <form id="contact-form" method="post" onSubmit={handleSubmit((data)=>{
                                console.log(data);
                            })} 
                                ...
                                <div className="contact-form">
                                    <div className="contact-input">
                                        <div className="contact-inner">
                                            <input {...register("name")} type="text" ref={register()} placeholder="Nom" value="yes" />
                                        </div>
                                        <div className="contact-inner">
                                            <input name="mail" type="email"  ref={register()} placeholder="Email " value="yes" />
                                        </div>
                                    </div>
                                    <div className="contact-inner">
                                        <input name="subject" type="text" ref={register()} placeholder="Objet " value="yes" />
                                    </div>
                                    <div className="contact-inner contact-message">
                                        <textarea name="message" ref={register()} placeholder="Message." value="yes" ></textarea>
                                    </div>
