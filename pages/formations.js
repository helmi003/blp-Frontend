            ...
            <div className="row">
                <div className="col-12">
                    <div className="breadcrumb_box text-center">
                        <h2 className="breadcrumb-title text-color-primary">FORMATIONS</h2>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <a href="#" className="ht-box-images style-03 wow move-up">
                                <div className="image-box-wrap">
                                    ...
                                    <div className="content">
                                        ...
                                        <div className="text">“ Inscrirez-vous au diplôme tunisien et bénéficier d'un diplôme français public avec nos partenaires.”</div>
                                    </div>
                                </div>
                            </a>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title-wrap text-center section-space--mb_40">
                                <h3 className="heading">Bénéficiez par <span className="text-color-primary"> nos formations</span></h3>
                            </div>
                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-8 col-lg-7">
                            <div className="cta-content md-text-center">
                                <h3 className="heading text-white">First smart Co-working place  <span className="text-color-secondary"> in AFRICA</span></h3>
                            </div>
                        </div>
