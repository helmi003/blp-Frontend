                ...
                <div class="col-12">
                    <div class="breadcrumb_box text-center">
                        ...
                        <ul class="breadcrumb-list">
                            ...
                            <li class="breadcrumb-item active">Signature de Convention avec ANAT</li>
                        </ul>
                    </div>
                </div>
            </div>
                                            ...
                                            <div className="swiper-wrapper">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/conventions/convention-blp-anat.webp"
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/conventions/convention-avec-anat.webp"
                                                                alt="signature de convention"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/conventions/convention-anat.webp"
                                                                alt="signature de convention"/>
                                                        </div>
                                                    </div>
                        ...
                        <div className="col-lg-12">
                            ...
                            <a className="single-gallery gallery-grid wow move-up"
                                ...
                                <a className="single-gallery gallery-grid wow move-up"
                                    ...
                                    <div className="single-gallery__item">
                                        <div className="single-gallery__thum bg-item-images bg-img"
                                            data-bg="assets/images/conventions/convention-anat.webp">
