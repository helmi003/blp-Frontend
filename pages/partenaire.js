...
<div id="main-wrapper">
    <div className="site-wrapper-reveal">
                    ...
                    <div className="col-lg-6 col-md-7">
                        <div className="cybersecurity-hero-text wow move-up">
                            ...
                            <div className="bedraw-button">
                                <a href="contact" className="ht-btn ht-btn-md">Inscription <i
                                            ...
                                            <div className="swiper-wrapper">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/demo-images/signiature-convention.jpg"
                                                                alt="signiature-convention-blp"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/demo-images/signiature.jpg"
                                                                alt="signiature-convention-blp"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/demo-images/reunion.jpg"
                                                                alt="reunion-partenariat-blp"/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="swiper-slide">
                                                    ...
                                                    <div className="carousel-slider wow move-up">
                                                        <div className="carousel-slider__image">
                                                            <img className="img-fluid"
                                                                src="assets/images/demo-images/4.jpg"
                                                                alt="partenariat-blp"/>
                                                        </div>
                                                    </div>
        ...
        <div className="pricing-table-area section-space--ptb_100 ">
                                            ...
                                            <div className="col-12">
                                                <div className="feature-images__two small-mt__10">
                                                    <div className="modern-grid-image-box row row--30">
                                                        ...
                                                        <div
                                                            className="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60  small-mt__40">
                                                        ...
                                                        <div
                                                            className="single-item wow move-up col-lg-4 col-md-6 section-space--mt_60">
