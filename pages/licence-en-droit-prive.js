        ...
        <div className="row">
            <div className="col-12">
                <div className="breadcrumb_box text-center">
                    <h2 className="breadcrumb-title ">Licence en droit privé</h2>
                                            ...
                                            <div className="card">
                                                ...
                                                <div id="collapseOne" className="show" aria-labelledby="headingOne"
                                                    ...
                                                    <div className="card-body">
                                                        <p>La Licence en <b>Droit Privé</b> présente un parcours que les
                                                            étudiants peuvent choisir suite à la deuxième année
                                                            de la Licence en Droit qui constitue avec la première année
                                                            les troncs communs aux études en Licence.
                                                            Cette licence fondamentale en droit privé tend à munir les
                                                            étudiants des connaissances nécessaires
                                                            pour pratiquer les métiers en relation avec le domaine du
                                                            droit privé ou pour continuer leurs études
                                                            et se spécialiser en droit privé interne ou international.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-lg-12 ">
                                            <table className="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>UE F53</td>
                                                        <td>Contentieux des contrats spéciaux</td>
                                                        <td>42H</td>
                                                        <td>21H</td>
                                                        <td></td>
                                                        <td>6</td>
                                        ...
                                        <div className="col-lg-12 ">
                                            <table className="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>UE F61</td>
                                                        <td>Droit intetnarional privé </td>
                                                        <td>42H</td>
                                                        <td>21H</td>
                                                        <td></td>
                                                        <td>6</td>
                                                    ...
                                                    <tr>
                                                        <td>UE F63</td>
                                                        <td>Procédures civiles et voies d'exécution</td>
                                                        <td>42H</td>
                                                        <td>21H</td>
                                                        <td></td>
                                                        <td>6</td>
                                                                ...
                                                                <div id="accordion_two">
                                                                    ...
                                                                    <div className="card">
                                                                        ...
                                                                        <div id="collapse__11" className="collapse"
                                                                            ...
                                                                            data-parent="#accordion_two">
                                                                            <div className="card-body">
                                                                                <p>Les quatre premiers semestres sont
                                                                                    réservés à des modules communs
                                                                                    relevant à la fois du droit public
                                                                                    et du droit privé. Les options y
                                                                                    sont obligatoires. <br/>
                                                                                    Le cinquième et le sixième semestre
                                                                                    sont réservés à la spécialisation ;
                                                                                    c’est dans ce cadre
                                                                                    que des thématiques spéciques en
                                                                                    droit privé sont traitées. <br/>
                                                                                    Précisons que le programme des six
                                                                                    semestres est conforme aux
                                                                                    recommandations
                                                                                    de la Commission sectorielle en
                                                                                    Droit. </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
